...
<body>
    <form name="form" action="" method="post">
        <table width="600" border="0">
            ...
            <input type="radio" name="cinsiyet" value="Kadın">Kadın</td>
</tr>
<tr>
    <td>MAAŞ:</td>
...
<tr>
    <td>ÇOCUK SAYISI:</td>
    <td><input type="radio" name="cocuk_sayisi" value="1">1
...
if(isset($_POST["ekle"]))
{
    ...
    {$sonmaas=$kmaas+700;}
    if($db)
    { echo "Veritabanına baglantı gerçekleşti ";}
...
if(isset($_POST["sil"]))
{
    $ktc=$_POST["tc"];
    if($db)
    { echo "Veritabanına bağlantı gercekleşti";}
...
if(isset($_POST["listele"]))
{
    ...
    while ($gelenveri=$listele->fetch())
    {
        echo "Adı: ".$gelenveri['ad']."".
         ...
         "<br>Toplam Maaş: ".$gelenveri['tmaas']."<br>".
    }
}
